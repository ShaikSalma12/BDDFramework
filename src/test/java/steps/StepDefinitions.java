...
public class StepDefinitions {
	...
	public void user_clicks_on_link(String xpath) {
...
// with headings by using list of list.. 
...
public void user_enters_details_in_registration_form2(DataTable dataTable) {
    ...
    // For other transformations you can register a DataTableType.
	List<List<String>> allLists =dataTable.asLists();
	driver.findElement(By.xpath("//input[@name='username']")).sendKeys(allLists.get(1).get(0));
	driver.findElement(By.xpath("//input[@name='password']")).sendKeys(allLists.get(1).get(1));
	driver.findElement(By.xpath("//input[@name='re_password']")).sendKeys(allLists.get(1).get(2));
	driver.findElement(By.xpath("//input[@name='full_name']")).sendKeys(allLists.get(1).get(3));
	driver.findElement(By.xpath("//input[@name='email_add']")).sendKeys(allLists.get(1).get(4));
	driver.findElement(By.xpath("//input[@name='captcha']")).sendKeys(allLists.get(1).get(5));
   
}
*/

// with headings by using map 
@When("user enters details in registration form2")
public void user_enters_details_in_registration_form2(DataTable dataTable) {
    // Write code here that turns the phrase above into concrete actions
    // For automatic transformation, change DataTable to one of
